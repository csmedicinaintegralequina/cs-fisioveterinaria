...
<div className="mb-8" />
  ...
  <a
    href={`/pequenos-animales/propietarios/${propietario.id}/editar`}
className="
  text-sm
  font-semibold
  text-amber-600
...
"
 ...
 <div className="flex items-center justify-between mb-6">
  ...
  {historia && (
    <a
      href={`/pequenos-animales/pacientes/${paciente.id}/editar-historia`}
      className="
        text-sm
        font-semibold
        text-amber-600
  ...
  {historia ? (
    ...
    <a
      href={`/pequenos-animales/pacientes/${paciente.id}/historia-clinica`}
      className="
        inline-block
        bg-[#0B6A74]
        text-white
...
py-3 md:py-4
    ...
    >
      ...
      <div className="max-w-4xl mx-auto mt-6 bg-white rounded-3xl shadow-xl p-6 md:p-8">
       ...
       <a
  href={`/pequenos-animales/pacientes/${paciente.id}/nuevo-diagnostico`}
  className="
    inline-block
    bg-[#0B6A74]
    text-white
...
{diagnosticosPaciente.map((diag) => {
  ...
  <a
    href={`/pequenos-animales/pacientes/${paciente.id}/editar-diagnostico/${diag.id}`}
  ...
  <a
    href={`/pequenos-animales/pacientes/${paciente.id}/eliminar-diagnostico/${diag.id}`}
    className="text-2xl hover:scale-110 transition"
    title="Eliminar"
  >
    🗑️
